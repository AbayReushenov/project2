...
function change_heading() {
    color = rndm_colour();
    document.getElementById("colorgame").style.color = color;
    document.getElementById("colorgame").style.fontFamily = "Impact,Charcoal,sans-serif";
}

function show_hide() {
    if (document.getElementById("appear").style.display == 'none' && document.getElementById("appear2").style.display == 'none' && document.getElementById("appear3").style.display == 'none' && document.getElementById("appear4").style.display == 'none' && document.getElementById("appear5").style.display == 'none' && document.getElementById("appear6").style.display == 'none') {
...
function validateQuestions() {
    if (
        validateForm() && validateRadio_1() && validateRadio_2() && validateNumber() && validateRadio_4() && validateRadio_5()) {
        return true;
    } else {
        return false;
    }
